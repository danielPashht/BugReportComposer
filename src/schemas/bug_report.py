...
class BugReportSchema(BaseModel):
    ...
    description_of_the_issue: str = Field(alias="Description of the issue", description="Description of the bug")
    steps: str = Field(alias="Steps", description="Steps to reproduce")
    expected_result: str = Field(alias="Expected result", description="Expected behavior")
